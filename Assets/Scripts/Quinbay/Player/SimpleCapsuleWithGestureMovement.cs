...
{
    public class SimpleCapsuleWithGestureMovement : MonoBehaviour
    {
        ...
        private bool forceMoveForward = false;
        ...
        void StickMovement()
        {
            ...
            primaryAxis.Set(0f, forceMoveForward ? 1f : 0f);
            #endregion
